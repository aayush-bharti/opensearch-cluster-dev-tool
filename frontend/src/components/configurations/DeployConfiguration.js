...
import AdvancedDeployConfiguration from "./AdvancedDeployConfiguration";
  ...
  return (
    <EuiPanel paddingSize="l" hasShadow borderRadius="m">
      ...
      <EuiFlexGroup direction="column" gutterSize="xl">
            ...
            >
              <EuiSelect
                ...
                options={[
                  ...
                  { value: "prefix_list", text: "Prefix List" },
                  { value: "ipv4", text: "IPv4 CIDR" },
                  { value: "ipv6", text: "IPv6 CIDR" },
                  { value: "security_group_id", text: "Security Group ID" },
                ]}
              />
            </EuiFormRow>
          </EuiFlexItem>
        ...
        {showAdvanced && <AdvancedDeployConfiguration config={config} onChange={onChange} />}
      </EuiFlexGroup>
    </EuiPanel>
  );
};
